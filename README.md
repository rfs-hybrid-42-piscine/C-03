...
<div align="center">
  <img src="https://raw.githubusercontent.com/rfs-hybrid/42-piscine-artwork/main/assets/covers/cover-c03.png" alt="C 03 Cover" width="100%" />
</div>
...
1. **Clone the repository:**
   ...
   **Option A: Clone this module directly**
   ```bash
   git clone git@github.com:rfs-hybrid-42-piscine/C-03.git C-03
   cd C-03
   ```
